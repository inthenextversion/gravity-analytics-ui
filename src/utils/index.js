...
export function getMiningPoolLink(token0Address) {
  return `https://gravityfinance.io/uni/ETH/${token0Address}`
}
...
export const urls = {
  ...
  showAddress: (address) => `https://www.polygonscan.com/address/${address}/`,
  showToken: (address) => `https://www.polygonscan.com/token/${address}/`,
