...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? 'ffa600' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#ffa600' : 'ffa600',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : 'ffa600',

  // secondary colors
  secondary1: darkMode ? '#ffa600' : 'ffa600',
